...
IGL_INLINE bool igl::unproject_onto_mesh (
	...
	using namespace Eigen;
	Vector3f s, dir;
	unproject_ray (pos, model, proj, viewport, s, dir);//这里通过各种视角和鼠标坐标计算出了射线的两个顶点坐标
	Hit hit;
